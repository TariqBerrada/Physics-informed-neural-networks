...
Nt = 50000
Nf = 20000
t_f = np.linspace(0, 720, Nf)[None].T
...
train_loss, val_loss, lr_list = train_glycemic(model, train_loader, test_loader, optimizer, scheduler, 50, weights_dir = './weights/schrodinger_60_5.pth.tar', type_ = 'LBFGS')
