...
def validate_glycemic(model, dataloader, limit_conditions = None, u_type = None):
    model.eval()
    device = model.device
    running_loss = 0.0
...
def fit_glycemic(model, dataloader, optimizer, scheduler, limit_conditions = None, type_ = 'LBFGS', u_type = None):
    model.train()
